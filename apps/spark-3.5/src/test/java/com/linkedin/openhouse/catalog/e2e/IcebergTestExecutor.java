 ...
 * </pre>
 * 
 * <p>Gradle automatically resolves ALL transitive dependencies, so the test classes
 * and all their dependencies (Hive, ORC, etc.) are available at runtime.
 * 
 * <p>This approach:
 * - ✅ Zero file copying
 * - ✅ Zero manual dependency management
 * - ✅ Gradle handles all transitive dependencies
 * - ✅ Tests run with OpenHouse catalog via ServiceLoader
 */
